/* =========================================================
   TECHCONNECT 2026 — REGISTRATION FORM LOGIC (Stage 2)
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  form.addEventListener("submit", function (event) {
    ...
    // 4. Extra sanity check on the email format.
    ...
    fetch(
      "https://tech-connect-2026.app.n8n.cloud/webhook/techconnect-registration",
      {
        method: "POST",
